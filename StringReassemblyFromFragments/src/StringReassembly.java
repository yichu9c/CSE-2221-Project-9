...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        return str1.concat(str2.substring(overlap));
    }
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
            String str) {
        assert strSet != null : "Violaion of: strSet is not null";
        ...
        boolean strIsSubstring = false;
        //Checks to see is str is a substring of any string in strSet
        ...
        /*
         * If str is not a substring removes any strings in strSet that are a
         * substring of str.
         */

        if (!strIsSubstring) {
            Set<String> strSetTemp = strSet.newInstance();
            ...
            strSet.transferFrom(strSetTemp);
            strSet.add(str);
        }
